...
<head>
    ...
    <title>Max Logistic Packers Movers || Pay Now</title> 
...
<?php $page = 'index'; include('php/header.php'); ?>
   ...
   <section class="page-not-found qrcode-page">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <img src="img/qrcord.png" class="qrcord" alt="404 text">
            </div>
            <div class="col-12">
                <h4>If You Complete your Transaction.<br />
                Shear Your Transaction Receipt <br/>Our Whatsapp Number 9355044442. </h4>
                <h2>Thank You.</h2>
